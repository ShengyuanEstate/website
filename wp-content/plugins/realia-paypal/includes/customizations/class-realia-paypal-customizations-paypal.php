 ...
 *
 * @class Realia_PayPal_Customizations_PayPal
...
class Realia_PayPal_Customizations_Paypal {
    ...
    public static function customizations( $wp_customize ) {
        $wp_customize->add_section( 'realia_paypal', array(
            'title'     => __( 'Realia PayPal', 'realia-paypal' ),
            'priority'  => 1,
        ) );
        ...
        $wp_customize->add_control( 'realia_paypal_client_id', array(
            'label'         => __( 'Client ID', 'realia-paypal' ),
        ...
        $wp_customize->add_control( 'realia_paypal_client_secret', array(
            'label'         => __( 'Client Secret', 'realia-paypal' ),
            'section'       => 'realia_paypal',
        ...
        $wp_customize->add_control( 'realia_paypal_live', array(
            'label'         => __( 'Live Mode', 'realia-paypal' ),
            'type'          => 'checkbox',
            'section'       => 'realia_paypal',
        ...
        $wp_customize->add_control( 'realia_paypal_credit_card', array(
            'label'         => __( 'Credit Card', 'realia-paypal' ),
            'type'          => 'checkbox',
            'section'       => 'realia_paypal',
...
Realia_PayPal_Customizations_Paypal::init();
